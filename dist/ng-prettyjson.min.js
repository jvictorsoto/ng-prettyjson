/** 
* @license ng-prettyjson - v0.2.1
* (c) 2013 Julien VALERY https://github.com/darul75/ng-prettyjson
* License: MIT 
**/
!function(a){"use strict";a.module("ngPrettyJson",[]).directive("prettyJson",["$compile","$templateCache","ngPrettyJsonFunctions",function(b,c,d){var e=a.isDefined;return{restrict:"AE",scope:{json:"=",prettyJson:"=",edition:"=",onEdit:"&"},replace:!0,link:function(f,g,h){var i={},j=null;f.id=h.id||"jsonEditor"+function(){return Math.floor(9999*Math.random())+1}(),f.editActivated=!1,f.aceEditor=void 0!==window.ace;
// compile template
...
a.isObject(b)&&e(b.json)?(l(),f.$watch(m+".json",function(a){f.editActivated||n(a),i=a},!0)):(f.editActivated||n(b),i=b),j&&(j.removeListener("change",o),j.setValue(JSON.stringify(b,null,"\t")),j.on("change",o),j.resize())},!0);var o=function(a){try{i=JSON.parse(j.getValue()),f.parsable=!0}catch(a){f.parsable=!1}
// trigger update
